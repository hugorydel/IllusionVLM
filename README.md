...
| :-----------------------------------------------------------------------------------: | :-----------------------------------------------------------------: |
|         ![Incongruent Example](examples/MullerLyer_str+049_diff+0.04000.png)          | ![Congruent Example](examples/MullerLyer_str-049_diff+0.04000.png)  |
...
![Error Rate vs Difficulty](examples/fig1_error_by_difficulty.png)
...
![Psychometric Curves](examples/fig3_psychometric_curves.png)
...
![PSE vs Strength](examples/fig2_pse_vs_strength.png)
