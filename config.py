...
# MODELS COMPARED
# ============================================================================
# Every model whose responses the analysis reads, in the order the figures list
# them. `key` names the model's folder under results/; `backend` says which
# Module 2 path produces its responses. The registry takes more than one model
# because it has held more than one: six open-weight VLMs were run and archived
# under archive/open_models/, which also records why they are not reported.
MODELS = [
