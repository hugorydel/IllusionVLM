"""
figures/build_dataset.py - Assemble the tidy tables the figures read.
...
from figures.conventions import ILLUSION_ORDER, apply_canonical_signs
from figures.human_data import (
...
from figures.robustness import slope_asymmetry
