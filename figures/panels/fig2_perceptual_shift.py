...
WHERE THE ESTIMATES COME FROM
    ...
    error. See figures/smoothing.py; the weighting is what keeps an
...
Rod-Frame and Delboeuf are held out; see conventions.FIGURES_EXCLUDED.
...
from figures.conventions import DISPLAY_NAMES, FIGURE_ILLUSIONS
from figures.figstyle import (
    INK_PRIMARY,
    SERIES,
    apply_style,
    centred_panel_grid,
...
from figures.smoothing import smooth_magnitude
