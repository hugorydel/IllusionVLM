"""
pipeline/paper/run_figures.py - Build the paper's figure set end to end.
...
from pipeline.paper import build_dataset
from pipeline.paper.figures import (
    fig1_paradigm,
    fig2_magnitude,
    fig3_congruency,
)
...
def main() -> None:
    ...
    print("\nFigure 2 - magnitude against strength")
    fig2_magnitude.build(PAPER_DIR, FIG_DIR / "fig2_magnitude.png")
