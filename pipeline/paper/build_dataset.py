"""
pipeline/paper/build_dataset.py - Assemble the tidy tables the figures read.
...
from pipeline.paper.conventions import ILLUSION_ORDER, apply_canonical_signs
from pipeline.paper.human_data import (
    aggregate_psychometric_data,
    load_trials,
    restrict_to_shared_grid,
    validate_reconstruction,
)
from pipeline.paper.metrics import (
...
from pipeline.paper.robustness import slope_asymmetry
